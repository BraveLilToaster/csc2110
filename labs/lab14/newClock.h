...
class clockType
{
    ...
    friend clockType operator++(clockType& time);    
    friend bool operator<(const clockType& time1, const clockType& time2);    
    friend clockType operator++(clockType& time, int temp);    
